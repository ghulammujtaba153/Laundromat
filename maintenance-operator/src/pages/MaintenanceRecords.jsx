...
const MaintenanceRecords = () => {
  ...
  return (
      ...
      <div className="w-full h-screen backgroundimg">
        <h1 className="text-5xl ml-14 font-bold font-railextra text-center text-primary-black pt-16">Maintenance Dashboard</h1>
              ...
              <tbody>
                {items
                  ...
                  .map((item, index) => (
                    <tr
                      key={index}
                      className={`bg-white border-b dark:bg-gray-800 dark:border-gray-700 ${index % 2 === 0
                    ...
                    >
                      ...
                      <td className="px-6 py-4">Under Maintenance</td>
