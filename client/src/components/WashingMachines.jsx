  ...
  return (
    <>
      <div
        ...
        className="font-mono flex h-full m-2  mx-8 w-150 md:w-350 lg:w-350  justify-center items-center flex-col bg-white rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out cursor-pointer"
      >
        <img
          src={item.picture}
          alt="/"
          className="h-[295px] w-full object-contain ill p-2 rounded-lg "
        />
